...
public final class IndyUtils {
    ...
    public static String getTailsFilePath(Context c) {
        return c.getExternalCacheDir().getAbsolutePath();
//        return String.format("%b - %b - %b", c.getExternalCacheDir().canWrite(), c.getExternalCacheDir().canRead(), c.getExternalCacheDir().canExecute());
