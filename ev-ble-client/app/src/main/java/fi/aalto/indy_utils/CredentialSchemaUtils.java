...
public final class CredentialSchemaUtils {
    ...
    private static final String CSO_INFO_CREDENTIAL_SCHEMA_VERSION = "1.0";
    private static final String[] CSO_INFO_CREDENTIAL_SCHEMA_ATTRIBUTES = new String[]{"CSO"};

    public static final String DSO_DISTRICT_CREDENTIAL_SCHEMA_NAME = "DSO-District-Credential-Schema";
    private static final String DSO_DISTRICT_CREDENTIAL_SCHEMA_VERSION = "1.0";
    private static final String[] DSO_DISTRICT_CREDENTIAL_SCHEMA_ATTRIBUTES = new String[]{"district_id"};
